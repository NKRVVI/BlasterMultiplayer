...
void ABlasterHUD::DrawHUD()
{
	...
	if (GEngine)
	{
		...
		if (HUDPackage.CrosshairsColour == FLinearColor::Red)
		{
			SpreadScaled *= 0.8f;
		}
		else
...
void ABlasterHUD::DrawCrosshair(UTexture2D* Texture, FVector2D ViewportCenter, FVector2D Spread, FLinearColor CrosshairColour)
{
	...
	DrawTexture(Texture, TextureDrawPoint.X, TextureDrawPoint.Y, TextureWidth, TextureHeight, 0.f, 0.f, 1.f, 1.f, CrosshairColour);
}